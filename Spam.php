...
echo $RR."\n::#:Github ::[http://github.com/Rysnanto45U:] #";

echo $R."\n::#:Facebook ::[okokaris:] #";

echo $G."\n::#:YouTube ::[kaga punya yt:] #";

echo $GG."\n::#:Team ::[Remaja-ID Team;SpensakraIXI] #";
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		...
		echo "[]Rysnanto Sending Massage To[] # ".$G.$argv[1].$X."\n";	
...
echo "[]Rysnanto Sending Massage To[] # ".$G.$argv[2].$X."\n";
